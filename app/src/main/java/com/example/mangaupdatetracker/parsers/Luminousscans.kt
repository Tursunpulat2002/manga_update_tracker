...
private const val TAG = "Luminousscans"
class Luminousscans(url: String, private var mangaData: AllDataOfManga, private var lastChapter: String) {
    ...
    /**
     * Used to extract info from just Luminousscans
     */
    fun extractor(){
        /**
         * Used to extract info from just Luminousscans
        ...
        try {
            ...
            val aTags = chapters.select("a[href*=luminousscans.com]")

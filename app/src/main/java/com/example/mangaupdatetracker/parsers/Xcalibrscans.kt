...
private const val TAG = "Xcalibrscans"
class Xcalibrscans(url: String, private var mangaData: AllDataOfManga, private var lastChapter: String) {
    ...
    /**
     * Used to extract info from just Xcalibrscans
     */
    fun extractor(){
        /**
         * Used to extract info from just Xcalibrscans
        ...
        try {
            ...
            val aTags = chapters.select("a[href*=xcalibrscans.com]")
